package com.jemmyee.framework.app.pay.alipay.config;
...
public class AlipayConfig {
	...
	public static String partner = "2088202995451676";
	
	// 交易安全检验码，由数字和字母组成的32位字符串
	public static String key = "fbgiglzzrpobjntvxmh3ryr4i84p4x8n";
	
	// 签约支付宝账号或卖家收款支付宝帐户
	public static String seller_email = "jemmyee@gmail.com";
