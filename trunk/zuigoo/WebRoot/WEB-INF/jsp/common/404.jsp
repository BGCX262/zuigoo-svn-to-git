...
<script type="text/javascript">
		...
		function timeDesc() {
			if (all <= 0) {
				//self.location = "${approot}/main/right";
				history.go('-1');
			}
			var obj = gid("ts");
...
<body>
	...
	<img alt="" src="${approot}/static/images/common/403.png" /></h1>
	<h2><img src="${approot}/static/images/common/time.gif" /></h2>
	<p><font color='red'>404 ERROR</font></b></p>
	<p>系统将于&nbsp;&nbsp;<span id="ts"></span> 自动返回</p>
	<p>正在跳转中:如果没有自动跳转  <a href="#" onclick="history.go('-1');">请点击这里</a></b></p>
</body>
</html>