...
<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"%>
<%@ page import="com.jemmyee.core.app.pay.alipay.services.*"%>
<%@ page import="com.jemmyee.core.app.pay.alipay.util.*"%>
...
.new-btn-login {
	...
	background-image: url("${approot}/static/images/pay/alipay/new-btn-fixed.png");
	border: medium none;
}
...
<form name=alipayment onSubmit="return CheckForm();" action="${approot}/admin/payment/toAlipay"
