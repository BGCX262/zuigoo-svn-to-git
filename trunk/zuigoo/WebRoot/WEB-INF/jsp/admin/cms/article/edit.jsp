...
<%@ include file="/WEB-INF/jsp/admin/inc/meta.jsp"%>
  ...
  <div class="title_0">您的位置：内容管理 &gt;&gt; 修改文章</div>
 
<div class="add clear">
<div class="blank12"></div>
<form method="post" action="" id="item">
<table width="100%" border="0" cellpadding="0" cellspacing="0" class="add_table2">
 <tr>
    <td><span class="right">标题</span></td>
    <td><textarea rows="4" cols="60" name="title" id="title">${item.title}</textarea>
         </td>
  </tr>
  <tr>
    <td><span class="right">关键字</span></td>
    <td><textarea rows="4" cols="60" name="keywords" id="keywords">${item.keywords}</textarea>
         </td>
  </tr>
  <tr>
    <td><span class="right">作者<font color='red'>*</font></span></td>
    <td><input type="text" id="author" name="author" size="40" value="${item.author}">
         </td>
  </tr>
  <tr>
    <td><span class="right">来源<font color='red'>*</font></span></td>
    <td><input type="text" id="befrom" name="befrom" size="40" value="${item.befrom}">
         </td>
  </tr>
<!--  <tr>
...
<!--   <tr>
    ...
    <td width="79%"><textarea rows="4" cols="60" name="brief" id="brief">${item.brief}</textarea>
         </td>
  </tr> -->
  <tr>
    <td><span class="right">内容<font color='red'>*</font></span></td>
    <td><textarea name="content" id="content" style="width:800px;height:300px;">${item.content}</textarea>
      <script>
        KE.show({
                id : 'content',
                width:'90%',
                ...
                imageUploadJson : '${approot}${rooturi}/upload' //服务端上传图片处理URI
        });
