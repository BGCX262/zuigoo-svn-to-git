...
<table width="100%" border="0" cellpadding="0" cellspacing="0" class="add_table2">
  <tr>
    ...
    <td><textarea rows="4" cols="60" name="title" id="title"></textarea>
         </td>
  </tr>
  <tr>
    <td><span class="right">关键字</span></td>
    <td><textarea rows="4" cols="60" name="keywords" id="keywords"></textarea>
         </td>
  </tr>
  <tr>
    <td><span class="right">作者<font color='red'>*</font></span></td>
    <td><input type="text" id="author" name="author" size="40" value="最购网">
         </td>
  </tr>
  <tr>
    <td><span class="right">来源<font color='red'>*</font></span></td>
    <td><input type="text" id="befrom" name="befrom" size="40" value="最购网  www.zuigoo.com">
         </td>
  </tr>
 <!--   <tr>
...
<div align="center"> 
  <input type="hidden" name="categoryId" value="${online_taoke_category_id}"/>  
