     ...
     <script type="text/javascript">
            ...
            jQuery("#seoDesc").validate({
                ...
                jQuery('#item').validated(function(){
					//alert("通过验证");
                	 ajax_submit('yes','yes','添加','item','${approot}${rooturi}/add','${approot}${rooturi}/list/${online_article_category_id}/menu/0/0');
                	//window.parent.frame["treeRight"].reload();
				});
            });
            /* ]]> */
        </script>
...
<div id="right_w"><p>当前位置：系统管理 >>添加部门</p></div>
...
<table width="80%" border="0" cellpadding="0" cellspacing="0" class="add_table">
  <tr>
    ...
    <td width="79%">
    <input type="radio" name="isShowInNav" value="0" checked="checked"/>否
    <input type="radio" name="isShowInNav" value="1"/>是
    </td>
  </tr>
       <tr>
