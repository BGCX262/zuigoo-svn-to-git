            ...
            jQuery(function(){
               ...
               //       expression: "if (VAL) return true; else return false;",
                ...
                jQuery('#item').validated(function(){
					//alert("通过验证");
					 KE.sync('content');
                	edit_item('${app}','${entity}',approot+'/taoke/admin/${entity}/list/${online_taoke_category_id}/menu/0/0');
				});
            });
            /* ]]> */
        </script>
...
<table width="98%" border="0" cellpadding="0" cellspacing="0" class="add_table2">
  <tr>
    ...
    <td width="79%"><input type="text" id="title" name="title" value="${item.title}">
         </td>
  </tr>
   <tr>
    <td width="21%"><span class="right">关键字<font color='red'>*</font></span></td>
    <td width="79%"><input type="text" id="keywords" name="keywords" size="40" value="${item.keywords}">
         </td>
  </tr>
  <tr>
    <td width="21%"><span class="right">作者<font color='red'>*</font></span></td>
    <td width="79%"><input type="text" id="author" name="author" size="40" value="${item.author}">
         </td>
  </tr>
  <tr>
    <td width="21%"><span class="right">来源<font color='red'>*</font></span></td>
    <td width="79%"><input type="text" id="befrom" name="befrom" size="40" value="${item.befrom}">
         </td>
  </tr>
<!--  <tr>
